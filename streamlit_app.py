...
# منطقة رفع الملفات
uploaded_files = st.file_uploader("📤 ارفع ملفات Word أو PDF (حتى 50 ملف)", type=["docx", "pdf"], accept_multiple_files=True, key="file_uploader")

# زر لحذف جميع الملفات المرفوعة
if uploaded_files:
