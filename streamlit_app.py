import streamlit as st import os import fitz  # PyMuPDF from sklearn.feature_extraction.text import TfidfVectorizer from sklearn.metrics.pairwise import cosine_similarity import re

st.set_page_config(page_title="البحث في الأحكام القضائية", layout="wide") st.title("🔍 البحث الذكي في الأحكام بناءً على الوصف")
...
elif not uploaded_files: st.warning("يرجى رفع ملفات PDF أولاً.") elif not query_text: st.warning("يرجى إدخال وصف قانوني للبحث.")
