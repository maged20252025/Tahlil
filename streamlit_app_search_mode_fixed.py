...
if st.button("🔍 بدء البحث"):
    ...
    st.session_state.search_mode = st.radio("طريقة البحث:", ["كل الكلمات", "أي كلمة"], horizontal=True)
...
if uploaded_files and st.session_state.get("search_triggered"):
    ...
    for uploaded_file in files_to_search:
        ...
        for paragraph in text_blocks:
            ...
            if (st.session_state.search_mode == "كل الكلمات" and match_all) or (st.session_state.search_mode == "أي كلمة" and match_any):
