...
st.set_page_config(page_title="البحث الذكي في الأحكام", layout="wide")
st.title("📚 البحث الذكي في ملفات PDF وWord")

# تحميل الملفات
uploaded_files = st.file_uploader("📤 قم برفع ملفات الأحكام (PDF أو Word):", type=["pdf", "docx"], accept_multiple_files=True)
...
if st.button("🔍 تنفيذ البحث") and uploaded_files and query_text:
    ...
    st.warning("يرجى رفع ملفات PDF أو Word أولاً.")
elif not query_text:
